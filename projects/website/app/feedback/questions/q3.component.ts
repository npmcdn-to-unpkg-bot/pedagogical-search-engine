    ...
    template: `
        ...
        <form>
            <label class="wc-com-feedback-radiochoice">
                <input (click)="_click('worse')" type="radio" name="question">
            ...
            <label class="wc-com-feedback-radiochoice">
                <input (click)="_click('equivalent')" type="radio" name="question">
                It is equivalent
            ...
            <label class="wc-com-feedback-radiochoice">
                <input (click)="_click('potential')" type="radio" name="question">
            ...
            <label class="wc-com-feedback-radiochoice">
                <input (click)="_click('better')" type="radio" name="question">
